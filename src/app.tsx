...
function ChatBubble({ isAssistant, sender, message, avatar }) {
    return (
    ...
    return (
        <div className="border border-white/10 rounded-xl m-8 p-8">
            ...
            <div className="flex items-center justify-center gap-2 mt-8">
                ...
                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
            </div>
        </div>
    );
}
...
`)
    ...
    /*    const [files, setFiles] = React.useState({
          ...
          export default function App() {
            return (
              <div>
                <h1 className="text-xl font-bold">Hello from a multi-file setup!</h1>
                <p className="my-2">This button is imported from another file.</p>
                <Button />
              </div>
            );
          }
        ...
        <div className='h-screen'>
            ...
            >
                <ResizablePanel defaultSize={50} minSize={10}>
                    <ErrorBoundary>
                        <CodeEditor value={code} onValueChange={(e) => setCode(e)} />
                    </ErrorBoundary>
                </ResizablePanel>
                <ResizableHandle />
                <ResizablePanel defaultSize={50} minSize={10}>
